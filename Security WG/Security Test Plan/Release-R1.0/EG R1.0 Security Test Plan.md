...
|【ATP】创建任务、查询任务、测试报告下载、获取依赖应用、查询测试用例接口开发| 已完成|1.1 1.3 1.12 2.2 5.3 8.1 9.1 9.2 9.4|9.2未通过|EG-TST-SEC-004<br/>EG-TST-SEC-005<br>EG-TST-SEC-007|测试中|
|【ATP】定时删除过期数据、处理异常的运行中用例开发|已完成|9.1 9.2 9.4|9.2未通过|EG-TST-SEC-007|未开始|
|【ATP】遵从性测试用例开发|已完成|9.1 9.2 9.4|未开始|EG-TST-SEC-007|9.2未通过|
|【ATP】支持对依赖的生态应用一起实例化、卸载|已完成|9.1 9.2 9.4|9.2未通过|EG-TST-SEC-007|未开始|
|【ATP】病毒扫描用例开发|已完成|9.1 9.2 9.4|9.2未通过|EG-TST-SEC-007|未开始|
|【ATP】沙箱测试用例开发|已完成|9.1 9.2 9.4|9.2未通过|EG-TST-SEC-007|未开始|
