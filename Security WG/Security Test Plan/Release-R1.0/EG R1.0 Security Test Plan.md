...
| [【MECM】MECM Support Batch Distribution and Batch Deployment](https://gitee.com/OSDT/dashboard?issue_id=I249AF)        |    已完成    |  未开始  | 未开始     |
...
|  [【Developer】API界面优化，分析多语言SDK，集成到开发者平台](https://gitee.com/OSDT/dashboard?issue_id=I22V1U)        |   已完成   |  未开始  |  未开始     |
|  [【MECM 】MECM Support to query the capabilities](https://gitee.com/OSDT/dashboard?issue_id=I1Z3CN)        |   已完成   |  未开始  |  未开始     |
|  [【Example APP】support positioning service as an example app.](https://gitee.com/OSDT/dashboard?issue_id=I1W7UJ)        |   已完成   |  未开始  |  未开始     |
|  [【Developer】优化API管理，支持生态API的删除](https://gitee.com/OSDT/dashboard?issue_id=I1TDJF)        |   已完成   |  未开始  |  未开始     |
|  [【Developer】界面优化](https://gitee.com/OSDT/dashboard?issue_id=I1TDIS)        |   已完成   |  未开始  |  未开始     |
|  [【MECM】外部系统显示优化](https://gitee.com/OSDT/dashboard?issue_id=I1QYJJ)        |   已完成   |  未开始  |  未开始     |
| [【MECM】边缘仓库能力支持](https://gitee.com/OSDT/dashboard?issue_id=I1QXSY)       |   已完成   |  未开始  |  未开始     |
|  [【MECM】应用包管理优化--菜单项+应用包列表+应用包详情](https://gitee.com/OSDT/dashboard?issue_id=I1QXS5)        |   已完成   |  未开始  |  未开始     |
|  [【MEP-Agent】添加ak/sk配置接口](https://gitee.com/OSDT/dashboard?issue_id=I1QT48)       |   已完成   |  未开始  |  未开始     |
...
| Story        | 开发   |  合规安全测试  | 渗透安全测试  |
| --------   | -----:  | :----:  | :----:  |
| [【APPLCM】Support download application log interface](https://gitee.com/OSDT/dashboard?issue_id=I25M0K)     | 未完成   |   未开始     |   未开始     |
|   [【APPLCM】适配新版csar包结构，能够正确部署应用](https://gitee.com/OSDT/dashboard?issue_id=I24W9I)   | 未完成   |   未开始     |   未开始     |
|  [need to add the role of GUEST for all of GET APIs in MECM](https://gitee.com/OSDT/dashboard?issue_id=I24IKE)    | 未完成   |   未开始     |   未开始     |
|   [【MECM】MECM Support APP Rule Cofing From Portal](https://gitee.com/OSDT/dashboard?issue_id=I24700)   | 未完成   |   未开始     |   未开始     |
|   [【MECM】MECM Support APP Rule Config During APP Orchestration](https://gitee.com/OSDT/dashboard?issue_id=I246ZD)    | 未完成   |   未开始     |   未开始     |
|   [【MEP-Agent】增加获取token接口](https://gitee.com/OSDT/dashboard/issues?sort=created_at%20desc&labels=Sprint3&id=I23QX8)   | 未完成   |   未开始     |   未开始     |
|   [【Developer】CSAR包结构重构](https://gitee.com/OSDT/dashboard?issue_id=I23QX0)   | 未完成   |   未开始     |   未开始     |
|  [【Developer】部署应用流程适配，增加对依赖项的检测](https://gitee.com/OSDT/dashboard?issue_id=I23QWU)    | 未完成   |   未开始     |   未开始     |
|  [【Developer】应用发布界面优化](https://gitee.com/OSDT/dashboard?issue_id=I1XZMT)    | 未完成   |   未开始     |   未开始     |
|  [【MECM】MECM支持限制活动的并发会话数](https://gitee.com/OSDT/dashboard?issue_id=I1TH8K)    | 未完成   |   未开始     |   未开始     |
|  [【MECM】MECM支持权限处理，避免横向越权](https://gitee.com/OSDT/dashboard?issue_id=I1TH3T)    | 未完成   |   未开始     |   未开始     |
|   [【MECM】提供ak/sk分配功能](https://gitee.com/OSDT/dashboard?issue_id=I1R5LY)   | 未完成   |   未开始     |   未开始     |
|   [mepagent call mepserver service liveness api to keep heartbeat for app service](https://gitee.com/OSDT/dashboard?issue_id=I1R0VX)   | 未完成   |   未开始     |   未开始     |
|  [【MECM】增加对依赖应用的查询与部署提示](https://gitee.com/OSDT/dashboard?issue_id=I1QWVL)    | 未完成   |   未开始     |   未开始     |
|   [【Developer】打通应用成为无状态生态应用前后端流程](https://gitee.com/OSDT/dashboard?issue_id=I1QWV9)   | 未完成   |   未开始     |   未开始     |
|   [mepserver add app heartbeat API, referring to etsi mec 011 latest stable draft](https://gitee.com/OSDT/dashboard?issue_id=I1QT6E)   | 未完成   |   未开始     |   未开始     |
