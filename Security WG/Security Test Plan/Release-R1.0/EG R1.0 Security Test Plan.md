...
|【ATP】创建任务、查询任务、测试报告下载、获取依赖应用、查询测试用例接口开发| 已完成|1.1 1.3 1.12 2.2 5.3 8.1 9.1 9.2 9.4|1.1,1.12,2.2,8.1,9.1,9.4通过,9.2未通过|EG-TST-SEC-004<br/>EG-TST-SEC-005<br>EG-TST-SEC-007|[I28UOG未通过](https://gitee.com/OSDT/dashboard?issue_id=I28UOG),其他全部通过|
