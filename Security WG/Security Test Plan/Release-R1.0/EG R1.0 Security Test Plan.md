...
| [【MEP】MEP Support to query the capabilities.](https://gitee.com/OSDT/dashboard?issue_id=I1W7UU)        |    已完成    | 1.1， 8.1， 9.4 |  未开始  | 未开始     |
...
| [mepserver app heartbeat design documentation](https://gitee.com/OSDT/dashboard?issue_id=I1QT6P)        |   已完成   | 1.2 |  未开始  |  未开始     |
