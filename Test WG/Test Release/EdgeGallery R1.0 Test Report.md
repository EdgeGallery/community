...
测试主要包括交付需求测试，分别从系统功能性、稳定性、易用性以及安全性（详见安全测试报告）方面进行测试，同时针对个别场景进行专项测试，问题单提单量总计219个，其中安全类问题39个，经评审遗留9个，其中安全测试问题4个，功能性问题5个。
...
- 遗留Defect Index，即DI=2 * 0.1+6 * 1+1 * 3=9.2<10，满足版本发布质量要求。
