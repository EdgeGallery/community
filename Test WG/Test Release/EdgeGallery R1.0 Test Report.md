...
|【Dev/MECM/App/Atp/MEP/APPLCM】EdgeGallery生态能力优化| |3人天 |2020/12/02 |2020/12/06 |2020/12/11 |2020/12/12 |1人天 | 李治谦|100%|
...
|【ATP】App应用的测试能力增强| |3人天 |2020/12/14 |2020/12/19 |2020/12/14 |2020/12/19 |4人天 | 张阿利|100%|
|【Developer】应用发布界面优化| |3人天 |2020/12/14 |2020/12/19 |2020/12/14 |2020/12/19 |4人天 |李媛媛|100%|
|【Dev/MECM/App/Atp/MEP/APPLCM】EdgeGallery生态能力优化| |3人天 |2020/12/14 |2020/12/19 |2020/12/23 |2020/12/24 |1人天 | 李治谦|%|
...
|【MECM】Application Managment & Topology Enhancement | |3人天 |2020/12/14 |2020/12/19 |2020/12/06 |2020/12/19 |4人天 | 张阿利|100%|
|UI自动化脚本开发| |3人天 |2020/12/23 |2020/12/25 |2020/12/23 |2020/12/25 |3人天 |李媛媛|100%|
|developer模块api自动化脚本维护| |5人天 |2020/12/14 |2020/12/19 |2020/12/14 |2020/12/19|5人天 |李媛媛|100%|
|appstore、mecm模块api自动化脚本维护| |10人天|2020/12/14|2020/12/26 |2020/12/14 |2020/12/26 |10人天 |张阿利 |100%|
...
已剔除 9个无效bug后，总缺陷数量： 198（含 32个安全类缺陷），已解决数量：178 个；未解决bug 24个（含6 个known issue，遗留到下一版本解决）。

3.3.2 缺陷分析 Defects Analysis

按缺陷类型分析：安全类bug 34个；其他类bug 173个。
按缺陷严重级别分析：严重bug 14个；主要bug 71个；次要bug 86个；不重要bug 10个；不指定26 个。
按需求点分析
缺陷收敛性分析：总计207 个bug（含 9个无效bug；含安全类bug 34）；迭代一 22 个bug（含 1个无效bug）；迭代二 84 个bug（含 5个无效bug）；迭代三 75 个bug（含 2个无效bug）；未制定迭代 26 个bug（含 1个无效bug）
...
测试主要包括交付需求测试，分别从系统功能性、稳定性、易用性方面进行测试，同时针对个别场景进行专项测试，总计210，经评审遗留X个
安全测试主要聚焦在会话，日志，敏感信息，权限认证，受攻击等角度进行测试，权限认证和会话测试在0.9版本里进行测试， 1.0版本基本延续同样的代码设计，问题不大。
1.0版本主要集中在日志和敏感信息以及少量的安全攻击方面的问题，测试结果包括大部分功能问题单外，少量安全问题都有issue进行跟踪，安全测试总共发现问题39个，35个bug，4个漏洞，其中安全问题重放攻击改动较大建议遗留，炸弹攻击已做修改，并作测试验证通过，其余bug问题,进行跟踪并全部完成回归。
