| **需求名称**                 | **需求描述**         | <img width=400/>**涉及模块** | **工作组**              | <img width=400/>**提案人** | **架构组意见** |
|---------------------------------|------------------|-------------|-----------|------------|---------------|
...
| EdgeGallery生态能力优化 | 增加依赖项部署的能力，当应用需要依赖其他已开放给EdgeGallery的应用时，需要预先部署依赖项，再部署应用 |   |MECM PT、Appand Dev Joint PT | 孙靖涵 |  |